<template>
  <div class="agendar">
            ...
            <div class="training-schedule-table table-responsive">
              ...
              >
                ...
                <template #cell(monday)="data">
                  <div
                    v-if="actualUser && actualUser.role === 'user'"
                    class="role_user"
                  >
                    <div
                      v-if="data.item.getCantReservesByDay(1) < cantMaxReserv"
                    >
                      <h4>
                  ...
                  <div v-else-if="actualUser && actualUser.role === 'admin'">
                    ...
                    >
                      ...
                      <ul v-if="data.item.getUsersReservByDay(1).length > 0">
                        <li
                          v-for="(user, idx) in data.item.getUsersReservByDay(
                            1
                          )"
                          :key="idx"
                        >
                ...
                <template #cell(tuesday)="data">
                  ...
                  >
                    <div
                      v-if="data.item.getCantReservesByDay(2) < cantMaxReserv"
                    >
                      <h4>
                ...
                <template #cell(wednesday)="data">
                  ...
                  >
                    <div
                      v-if="data.item.getCantReservesByDay(3) < cantMaxReserv"
                    >
                      <h4>
                ...
                <template #cell(thursday)="data">
                  ...
                  >
                    <div
                      v-if="data.item.getCantReservesByDay(4) < cantMaxReserv"
                    >
                      <h4>
                ...
                <template #cell(friday)="data">
                  ...
                  >
                    <div
                      v-if="data.item.getCantReservesByDay(5) < cantMaxReserv"
                    >
                      <h4>
    ...
    <b-container v-else class="py-ag">
      <b-row>
        <b-col>
          <h2 class="text-center text-uppercase fst-italic">
            <span>Para agendar debes estar logeado</span>
          </h2>
        </b-col>
      </b-row>
    </b-container>
